...
describe("VideoPlayerWithWatermark", () => {
    it("should render", async () => {
        render(<VideoPlayerWithWatermark embedUrl="https://player.mediadelivery.net/embed/566190/6e562abd-086a-45b2-bdaa-820ebce7289a" userName="Test User" userCpf="1234567890" />);
