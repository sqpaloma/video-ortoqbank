...
export function PricingPlanCard({
  ...
  return (
    <div className="group relative rounded-2xl overflow-hidden w-full flex flex-col">
      ...
      <div className="text-center py-4">
        <div className="inline-block px-4 py-1 rounded-full text-xs font-bold text-brand-blue">
          {plan.badge}
        </div>
      </div>
      ...
      <div className="text-center px-6 pb-6">
        <div className="h-20 flex flex-col justify-center">
          <div className="text-lg line-through mb-2 text-red-500">
