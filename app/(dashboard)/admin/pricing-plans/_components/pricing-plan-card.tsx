...
export function PricingPlanCard({ plan, onEdit, onDelete }: PricingPlanCardProps) {
  return (
    <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden w-full flex flex-col">
      ...
      <div className="bg-gray-50 px-4 py-3 border-b">
        <div className="flex items-center justify-between text-xs">
          ...
          <div className="flex flex-col items-end gap-1">
            <span className={`px-2 py-1 rounded-full text-xs font-bold ${plan.isActive
      ...
      <div className="p-6 `flex-shrink-0`">
        <div className={`w-full py-3 px-6 rounded-xl font-semibold text-sm text-center ${plan.isActive
