        ...
        <div className="space-y-6">
            ...
            <div className="mb-4 flex items-start gap-3">
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  ...
                  pensada para uma preparação estruturada, contínua e
                  estratégica para o TEOT e para a formação em Ortopedia. Para
                  aproveitar ao máximo, é importante entender como cada área
                  funciona e como ela se integra ao OrtoQBank, potencializando
                  seus resultados.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  ...
                  direcionar melhor a resolução de questões no OrtoQBank,
                  focando exatamente nos temas que você já estudou — ou que
                  precisa revisar.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  ...
                  cobrados no TEOT Conteúdo direto ao ponto, com enfoque prático
                  e prova-orientado Organização que permite seguir uma trilha
                  ...
                  fixação ativa do conteúdo e contato com o estilo real da
                  prova.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  ...
                  Marcar conteúdos que deseja rever antes da prova Criar uma
                  lista rápida para revisões estratégicas Organizar o estudo de
                  acordo com seu momento (R1, R2, R3 ou reta final) Essa
                  funcionalidade facilita revisões rápidas e estudos
                  direcionados, especialmente em fases mais avançadas da
                  preparação.
                  <br />
                  <br />
                  <b>➡️ Integração com o OrtoQBank:</b>
                  Os temas favoritos podem ser usados como base para criar
                  testes personalizados no OrtoQBank, permitindo revisar teoria
                  e prática de forma totalmente alinhada.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  A grande força da sua preparação está na integração entre
                  aulas e questões:
                  <br />
                  ...
                  <br />
                  <br />
                  Tudo isso para uma preparação mais eficiente, inteligente e
                  com foco em aprovação.
                </p>
              </CardContent>
            </Card>
          </div>
